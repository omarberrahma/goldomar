            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div className="relative">
                    ...
                    <div className="absolute -bottom-6 -right-6 bg-onyx-card border border-gold-500/20 p-6 rounded-2xl hidden md:block z-20">
                        ...
                        <span className="text-xs text-zinc-400 block mt-1">عراقة يدوية وأصالة مطلقة</span>
                    </div>
                </div>
                <div>
                    ...
                    <p className="text-zinc-400 text-sm leading-relaxed mb-6 font-light">
                        نحن لا نبيع مجوهرات فحسب، بل نصمم إرثاً ينتقل عبر الأجيال. نجمع في قطعنا بين عراقة الفن القديم وأدق تقنيات الصياغة الحديثة لضمان نقاوة تامة وبريق يدوم للأبد.
                    </p>
                    ...
                    <div className="space-y-4">
                        <div className="flex gap-4">
                            ...
                            <div>
                                <h4 className="text-sm font-bold text-white mb-1">تدقيق يدوي وفحص مجهري فائق</h4>
                                <p className="text-[12px] text-zinc-500">يتم فحص كل حجر كريم وتوزينه تحت أعلى درجات الدقة والخبرة.</p>
                            </div>
                        </div>
                        <div className="flex gap-4">
                            <div className="w-10 h-10 rounded-full bg-gold-600/10 border border-gold-500/20 flex items-center justify-center text-gold-400 shrink-0">
                            ...
                            <div>
                                <h4 className="text-sm font-bold text-white mb-1">تسليم ملكي وتوثيق رسمي</h4>
                                <p className="text-[12px] text-zinc-500">نلتزم بتوثيق كافة شهادات النقاوة الرسمية لضمان قيمتها كاستثمار وأثر فني.</p>
                            </div>
                        </div>
                    </div>
                </div>
